 ...
 * @author USER
 */
public class SeacrhUserUpdateFXMLController implements Initializable {
    ...
    @FXML
    public void UpdateButtonActionEvent(ActionEvent event) throws IOException
    {
        ...
        {
        try{  
        Parent root = FXMLLoader.load(getClass().getResource("UpdateUserFXML.fxml"));
